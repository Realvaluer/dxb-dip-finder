...
export function trackPropertyView(propertyId, propertyName, extra = {}) {
  send('property_view', {
    ...
    event_data: {
      ...
      change_pct: extra.change_pct != null ? extra.change_pct : null,
      purpose: extra.purpose || null,
      ready_off_plan: extra.ready_off_plan || null,
    },
  });
}
